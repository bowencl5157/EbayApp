#!/bin/bash
# Start script for eBay Product Research Tool (macOS - double-clickable)
...
osascript -e 'tell application "Terminal" to do script "cd '"$SCRIPT_DIR"'; source .venv/bin/activate; python main.py; exec bash"'
